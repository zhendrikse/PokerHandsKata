...
from PokerHands import determine_best_hand
...
when(PokerHands).rank_hand(full_house).thenReturn(1)
when(PokerHands).rank_hand(four_of_a_kind).thenReturn(2)
when(PokerHands).rank_hand(straight_flush).thenReturn(3)
